...
import { createStock } from "@/lib/stock-api";
import { listDematAccounts } from "@/lib/demat-account-api";
import { toast } from "sonner";

const AddStockDialog = ({ open, onOpenChange, onSuccess }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] p-0 h-[85vh] flex flex-col">
        ...
        <form onSubmit={handleStockSubmit} className="flex flex-col h-full">
          <div className="flex-1 overflow-y-auto">
            <div className="grid gap-4 p-4">
              ...
              <div className="grid gap-2">
                ...
                />
                {errors.stock_name && <p className="text-red-500 text-sm">{errorsatrices.stock_name}</p>}
              </div>
              <div className="grid gap-2">
