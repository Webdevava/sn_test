  ...
  const handleFileSubmit = async (e) => {
    ...
    try {
      if (file) {
        ...
        toast.success("Travel insurance saved without document");
      }
      onSuccess();
      handleClose();
    } catch (error) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[600px] p-0 h-[85vh] flex flex-col">
        <DialogHeader className="p-4 border-b">
          <DialogTitle>
            {step === 1 ? "Add Travel Insurance" : step === 2 ? "Add Nominees" : "Upload Document"}
          </DialogTitle>
        </DialogHeader>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInsuranceChange({ target: { id: "travel_type", value } })
                    }
                    required
                  >
                    <SelectTrigger>
