...
import {
  listPropertyInsurances,
  getPropertyInsuranceDetail,
  deletePropertyInsurance,
} from "@/lib/property-insurance-api";
  ...
  if (loading && !insurances.length) {
    return (
      <div className="flex justify-center items-center h-[60vh] animate-pulse">
        ...
        <p className="text-gray-500 text-sm sm:text-base">Loading property insurances...</p>
      </div>
    );
  }
    ...
    <div className="container mx-auto py-6 px-4 sm:py-12 sm:px-6 lg:px-8 relative">
      ...
      {error ? (
        <div className="flex flex-col justify-center items-center h-[60vh] bg-gray-50 rounded-lg text-center p-4 sm:p-6">
          <House size={36} className="mb-4 text-red-400 sm:size-48" />
        ...
        <div className="flex flex-col justify-center items-center h-[60vh] bg-gray-50 rounded-lg text-center p-4 sm:p-6">
          <House size={36} className="mb-4 text-gray-400 sm:size-48" />
          <p className="text-gray-500 text-base sm:text-lg">No property insurances found</p>
          <p className="text-gray-400 mt-2 text-sm sm:text-base">
            Click below to add your first property insurance
          </p>
          <div className="mt-4">
            <Button onClick={() => setOpenAddDialog(true)} className="gap-2">
              <House size={20} />
          ...
          {insurances.map((insurance) => (
            ...
            >
              <CardHeader className="p-4 sm:p-6 pb-0">
                <CardTitle className="text-base sm:text-lg">{insurance.policy_type}</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  ...
                  <div className="bg-popover p-2 rounded-lg">
                    ...
                    <p className="font-semibold mt-1 sm:mt-2 truncate">{insurance.property_address || "N/A"}</p>
                  </div>
                  <div className="bg-popover p-2 rounded-lg">
