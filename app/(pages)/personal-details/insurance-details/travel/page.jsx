...
import { listTravelInsurances, getTravelInsuranceDetails, deleteTravelInsurance } from "@/lib/travel-insurance-api";
    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold">Travel Insurances ({insurances.length})</h1>
        </div>
      ...
      <AddTravelDialog open={openAddDialog} onOpenChange={setOpenAddDialog} onSuccess={handleSuccess} />
      <EditTravelDialog open={openEditDialog} onOpenChange={setOpenEditDialog} insurance={selectedInsurance} onSuccess={handleSuccess} />

      {error ? (
        <div className="text-center py-20 bg-gray-50 rounded-lg">
          <Airplane size={48} className="mx-auto mb-4 text-red-400" />
        ...
        <div className="text-center py-20 bg-gray-50 rounded-lg">
          <Airplane size={48} className="mx-auto mb-4 text-gray-400" />
          <p className="text-gray-500 text-lg">No travel insurances found</p>
          <p className="text-gray-400 mt-2">Click below to add your first travel insurance</p>
          <div className="mt-4">
            <Button onClick={() => setOpenAddDialog(true)} className="gap-2">
              <Airplane size={20} />
              Add Insurance
          ...
          {insurances.map((insurance) => (
            <Card key={insurance.id} className="p-0 transition-all hover:shadow-lg hover:-translate-y-1">
              <CardHeader className="p-6 pb-0">
                <CardTitle>{insurance.travel_type}</CardTitle>
              </CardHeader>
              <CardContent>
