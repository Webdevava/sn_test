...
} from "@/lib/medical-insurance-api";
...
const MedicalPage = () => {
  ...
  const handleEdit = async (id) => {
    try {
      const response = await getMedicalInsuranceDetail(id);
      if (response.data) {
    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold">Medical Insurances ({insurances.length})</h1>
        </div>
      ...
      {error ? (
        <div className="text-center py-20 bg-gray-50 rounded-lg">
          <Stethoscope size={48} className="mx-auto mb-4 text-red-400" />
        ...
        <div className="text-center py-20 bg-gray-50 rounded-lg">
          <Stethoscope size={48} className="mx-auto mb-4 text-gray-400" />
          <p className="text-gray-500 text-lg">No medical insurances found</p>
          <p className="text-gray-400 mt-2">
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-popover p-2 rounded-lg">
                    ...
                    <p className="font-semibold mt-2 truncate">{insurance.policy_type || "N/A"}</p>
                  </div>
                  <div className="bg-popover p-2 rounded-lg">
                ...
                <div className="bg-background/85 text-xs p-2 rounded-lg flex gap-3 items-center w-60 justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => handleDownload(insurance.document_url)}
                      disabled={!insurance.document_url}
                    >
      ...
      <Dialog open={viewDialogOpen} onOpenChange={setViewDialogOpen}>
        <DialogContent className="sm:max-w-[90%] sm:max-h-[90%]">
          ...
          <div className="w-full h-full overflow-auto">
            {selectedInsurance?.document_url && (
              <iframe
                src={selectedInsurance.document_url}
                width="100%"
                height="600px"
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this medical insurance? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
