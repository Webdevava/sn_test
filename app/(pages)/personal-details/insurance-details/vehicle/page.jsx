...
} from "@/lib/vehicle-insurance-api";
          ...
          {insurances.map((insurance) => (
            ...
            >
              <CardHeader className="p-4 sm:p-6 pb-0">
                <CardTitle className="text-base sm:text-lg">{insurance.vehicle_type}</CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  ...
                  <div className="bg-popover p-2 rounded-lg">
                    ...
                    <p className="font-semibold mt-1 sm:mt-2 truncate">{insurance.vehicle_registration_number || "N/A"}</p>
                  </div>
                </div>
